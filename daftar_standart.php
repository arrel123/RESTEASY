...
// Deskripsi : File ini untuk menampilkan list kamar sesuai dengan tipe [Standard]
...
// Query untuk mengambil data kamar dengan tipe 'standard'
$query = mysqli_query($koneksi, "SELECT * FROM kamar WHERE tipe = 'standard' AND tersedia = 1");
?>
