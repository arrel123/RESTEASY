...
// Deskripsi : File ini untuk menampilkan list kamar sesuai dengan tipe [Suite]
...
// Query untuk mengambil data kamar dengan tipe 'suite'
$query = mysqli_query($koneksi, "SELECT * FROM kamar WHERE tipe = 'suite' AND tersedia = 1");
?>
